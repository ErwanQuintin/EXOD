...
m_path = args.path + "/{}_{}_{}_{}_{}/ds9_variable_sources.reg".format(
    int(args.m_dl), int(args.tw), args.bs, args.gtr, args.inst
)
...
corr_PN_M1 = corr_table[
    np.where((corr_table["INST_1"] == "PN") & (corr_table["INST_2"] == args.inst))
]
